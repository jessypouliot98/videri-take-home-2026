...
-- AddForeignKey
ALTER TABLE "AlertEvent" ADD CONSTRAINT "AlertEvent_creaedById_fkey" FOREIGN KEY ("creaedById") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
